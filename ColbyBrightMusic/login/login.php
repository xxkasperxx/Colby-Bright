 ...
 $numrows = mysql_numrows($query2);
     ...
     if ($numrows!=0)    // code to login
     {
        ...
        if($username==$dbusername&&$password==$dbpassword)
        {
            ...
            $left =   '<form method="POST" action="update.php">

Left-Side: <br/>
                <textarea name="updateLeft" rows="10" cols="30"></textarea><br><br>
 ...
 $numrows = mysql_numrows($query2);
     ...
     if ($numrows!=0)    // code to login
     {
        ...
        if($username==$dbusername&&$password==$dbpassword)
        {
            ...
            $right =   '<form method="POST" action="update.php">

right-Side: <br/>
                <textarea name="updateRight" rows="10" cols="30"></textarea><br><br>
<input type="submit" value="Finished" />
</form>'
...
<input type="hidden" name="encrypted" value="-----BEGIN PKCS7-----  -----END PKCS7-----
">
