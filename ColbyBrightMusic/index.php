...
<div id="logo">
		...
		<form action="index.php" method="POST">
			<div class="text">
				...
				<div class="news">
					<h2>News</h2>
					<a href="songs/takeoff.zip"><img src="images/all_or_nothing Season Cover.jpg"width="50%" border="0"/></a>
						<div class="release">
...
<?php
	...
	if (isset($right))
	{
		$result = mysql_query("UPDATE about SET rightside = '$right' WHERE id = '4' ");
	}
	if (isset($left))
	{
		$result = mysql_query("UPDATE about SET leftside = '$left' WHERE id = '4' ");  	
	}
